...
function throttle(func, limit) {
    ...
    if (newYearPopup && closePopupBtn) {
        // Hide hero badge initially
        if (heroBadge) {
        ...
        setTimeout(() => {
            newYearPopup.classList.remove('-translate-y-full');
            newYearPopup.classList.add('translate-y-0');
        }, 1000);

        // Function to close popup
        const closePopup = () => {
            newYearPopup.classList.remove('translate-y-0');
            newYearPopup.classList.add('-translate-y-full');
            
            // Show hero badge when popup closes
            setTimeout(() => {
                if (heroBadge) {
        ...
        setTimeout(() => {
            if (newYearPopup.style.display !== 'none') {
                closePopup();
            }
        }, 8000);
    }
